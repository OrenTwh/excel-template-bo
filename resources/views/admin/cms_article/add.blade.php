                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Add CMS Article</h3>
                        </div>
                        <div class="nk-block-head-content">
                            ...
                            <form id="cms_article_form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <small class="form-text text-muted">Upload article thumbnail image</small>
                                ...
                                <div class="mt-4 mb-4">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="invalid-feedback"></div>
                                            <small class="form-text text-muted">Upload multiple banners. They will appear as a carousel slider on the frontend.</small>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-primary" id="submit_btn">
                                            <em class="icon ni ni-save"></em><span>Create Article</span>
                                        </button>
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            col.innerHTML = `
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" class="form-control form-control-sm mb-2" placeholder="Alt text" data-banner-id="${banner.id}" name="banner_alt_text[${banner.id}]">
                        <input type="text" class="form-control form-control-sm mb-2" placeholder="Target Page" data-banner-id="${banner.id}" name="banner_target_page[${banner.id}]">
                        <input type="text" class="form-control form-control-sm mb-2" placeholder="Target Page Web" data-banner-id="${banner.id}" name="banner_target_page_web[${banner.id}]">
    ...
    $('#cms_article_form').on('submit', function(e) {
        ...
        // Banners
        const bannersData = window.bannerGallery.getBannersData();
        const bannerAltTexts = [];
        const bannerTargetPages = [];
        const bannerTargetPagesWeb = [];

        bannersData.forEach((banner, index) => {
            // Only append if banner.file is a valid File object
            if (banner.file && banner.file instanceof File) {
                formData.append(`banner_images[${index}]`, banner.file);
            }

            const altTextInput = document.querySelector(`input[name="banner_alt_text[${banner.id}]"]`);
            const targetPageInput = document.querySelector(`input[name="banner_target_page[${banner.id}]"]`);
            const targetPageWebInput = document.querySelector(`input[name="banner_target_page_web[${banner.id}]"]`);
        ...
        $.ajax({
            url: '{{ route("admin.cms_article.createProject") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    $('#modal_danger .caption-text').html(xhr.responseJSON?.message || 'Failed to create CMS article');
                    modalDanger.toggle();
                }
            }
        });
