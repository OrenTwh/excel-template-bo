    ...
    <div class="card-inner">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="mb-3 row">
                    <label for="{{ $voucher_edit }}_applicable_to" class="col-sm-5 col-form-label">{{ __( 'voucher.applicable_to' ) }}</label>
                    <div class="col-sm-7">
                        <select class="form-select" id="{{ $voucher_edit }}_applicable_to">
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( fe + '_submit' ).click( function() {
            ...
            formData.append( 'applicable_to', $( fe + '_applicable_to' ).val() );
        ...
        function getVoucher() {
            ...
            $.ajax( {
                ...
                success: function( response ) {
                    ...
                    $( fe + '_applicable_to' ).val( response.applicable_to || 'all' );
