        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="mb-3 row d-none">
                    ...
                    <div class="col-sm-7">
                        <select class="form-select" id="{{ $user_create }}_nationality" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'user.nationality' ) ] ) }}">
                ...
                <div class="mb-3 row">
                    <label for="{{ $user_create }}_invitation_code" class="col-sm-5 col-form-label">{{ __( 'user.invitation_code' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $user_create }}_invitation_code" placeholder="{{ __( 'template.optional' ) }}">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        let nationalitySelect2 = $( dc + '_nationality' ).select2( {
        ...
        $( dc + '_submit' ).click( function() {
            ...
            formData.append( 'invitation_code', $( dc + '_invitation_code' ).val() );
