...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Notification Module Language Lines
    |--------------------------------------------------------------------------
    |
    | The following language lines are used during Notification Module for various
    ...
    */
    ...
    'register_success_content' => 'Welcome to Xpark!',
    ...
    'user_checkin_success_content' => 'Checkin Success! Xpark Welcomes You Today',
    ...
    // 'topup_failed' => 'Topup Failed',
    // 'topup_failed_content' => 'Topup Failed! Please Try Again',
    'voucher_gifted_title'   => 'Voucher Received',
    'voucher_gifted_content' => 'You received a voucher gift from :name!',

    'profile_updated_title'   => 'Profile Updated',
    'profile_updated_content' => 'Your profile has been updated successfully.',

    'password_updated_title'   => 'Password Changed',
    'password_updated_content' => 'Your account password has been changed successfully.',
];
