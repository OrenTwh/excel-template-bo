...
return [
    ...
    */
    ...
    'header_message' => 'Please check the following error',
    ...
    */
    ...
    'custom' => [
        ...
        'banner_images.*' => [
            'image' => 'Each banner image must be a valid image file.',
            'mimes' => 'Each banner image must be in one of the following formats: JPEG, PNG, JPG, GIF, or WEBP.',
            'max'   => 'Each banner image may not be greater than 5MB.',
        ],
    
        'thumbnail' => [
            'image' => 'The thumbnail must be a valid image file.',
            'mimes' => 'The thumbnail must be in one of the following formats: JPEG, PNG, JPG, GIF, or WEBP.',
            'max'   => 'The thumbnail may not be greater than 5MB.',
        ],
    
        'publish_date' => [
            'required' => 'Please select a publish date.',
            'date'     => 'The publish date must be a valid date.',
        ],
    
        'status' => [
            'required' => 'Please choose a status.',
            'in'       => 'Invalid status selected. It must be either Active or Inactive.',
        ],
        'country_id' => [
