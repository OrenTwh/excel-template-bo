...
class UserController extends Controller
{
    ...
    public function add( Request $request ) {
        ...
        $this->data['data']['nationalities'] = Nationality::where('status', 10)->pluck('name','id')->toArray();
    ...
    public function userDownlines( Request $request ) {
        ...
        return UserService::userDownlines( $request );
    }

    public function sendTestNotification( Request $request ) {

        return UserService::sendAdminTestNotification( $request );
    }
}
